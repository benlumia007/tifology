...
( function( $ ) {
	...
	function initMainNavigation( container ) {
		...
		container.find( '.menu-item-has-children > a, .page_item_has_children > a' ).after( '<button class="dropdown-toggle" aria-expanded="false">' + tifologyscreenReaderText.expand + '</button>' );
		...
		container.find( '.dropdown-toggle' ).click( function( e ) {
			...
			_this.html( _this.html() === tifologyscreenReaderText.expand ? tifologyscreenReaderText.collapse : tifologyscreenReaderText.expand );
		} );
	}
