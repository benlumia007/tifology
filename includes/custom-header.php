...
================================================================================================
*/
function tifology_custom_header_setup() {
    $args = array(
        ...
        'wp-head-callback'       => 'tifology_header_style',
    );
    add_theme_support( 'custom-header', $args );
}
add_action('after_setup_theme', 'tifology_custom_header_setup');
...
================================================================================================
*/
function tifology_header_style() {
